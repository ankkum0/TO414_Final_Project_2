...
```{r}
## With 84% of the values being null anyways CHATGPT said to just create binary
# Count blanks
...
job$department_clean <- ifelse(dept_counts[job$department_clean] > 20,
...
# Optional: group any remaining very rare industries into "other"
...
job$loc_country_new <- ifelse(job$loc_country_val > 30, as.character(job$loc_country), "Other")
